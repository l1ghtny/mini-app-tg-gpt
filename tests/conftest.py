...
async def _seed_reference_data(engine) -> None:
    ...
    async with AsyncSession(engine, expire_on_commit=False) as session:
        ...
        session.add(
            TierModelLimit(
                tier_id=free.id, model_name="gpt-5.4-nano", monthly_requests=100
            )
        )
        session.add(
            TierModelLimit(
                tier_id=advanced.id, model_name="gpt-5.4-nano", monthly_requests=10000
            )
        )
        session.add(
        ...
        session.add_all(
            [
                ...
                ImageQualityPricing(
                    image_model="gpt-image-1.5", quality="standard", credit_cost=1.0
                ),
                ImageQualityPricing(
                    image_model="gpt-image-1.5", quality="auto", credit_cost=1.0
                ),
                ImageQualityPricing(
                ...
                ImageQualityPricing(
                    image_model="gemini-3.1-flash-image", quality="512", credit_cost=1.0
                ),
                ImageQualityPricing(
                    image_model="gemini-3.1-flash-image", quality="1k", credit_cost=2.0
                ),
                ImageQualityPricing(
                    image_model="gemini-3.1-flash-image", quality="2k", credit_cost=4.0
                ),
                ImageQualityPricing(
                    image_model="gemini-3-pro-image", quality="1k", credit_cost=2.0
                ),
                ImageQualityPricing(
                    image_model="gemini-3-pro-image", quality="2k", credit_cost=4.0
                ),
            ]
        )
