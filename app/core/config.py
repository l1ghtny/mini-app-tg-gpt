...
class Settings:
    ...
    VOICE_TRANSCRIPTION_UPLOAD_MAX_BYTES: int = int(
        os.getenv("VOICE_TRANSCRIPTION_UPLOAD_MAX_BYTES", str(20 * 1024 * 1024))
    )
    VOICE_TRANSCRIPTION_UPLOAD_MAX_DURATION_SECONDS: int = int(
        os.getenv("VOICE_TRANSCRIPTION_UPLOAD_MAX_DURATION_SECONDS", "1800")
    )
    VOICE_TRANSCRIPTION_UPLOAD_TIMEOUT_SECONDS: float = float(
        os.getenv("VOICE_TRANSCRIPTION_UPLOAD_TIMEOUT_SECONDS", "1800")
    )
    VOICE_TRANSCRIPTION_UPLOAD_MAX_PENDING_PER_USER: int = int(
        os.getenv("VOICE_TRANSCRIPTION_UPLOAD_MAX_PENDING_PER_USER", "2")
    )
    VOICE_TRANSCRIPTION_UPLOAD_MAX_QUEUE: int = int(
        os.getenv("VOICE_TRANSCRIPTION_UPLOAD_MAX_QUEUE", "100")
    )
    ...
    VOICE_TRANSCRIPTION_COST_PER_MINUTE_USD: str = os.getenv(
        "VOICE_TRANSCRIPTION_COST_PER_MINUTE_USD", "0.0045"
    ).strip()
